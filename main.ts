...
namespace Sensors
{
    //% blockId=RGB_LED1 block="Common Anode RGB LED set R pin %RedPin|R value(0~255) %RedValue|G pin %GreenPin|G value(0~255) %GreenValue|B pin %BluePin|B value(0~255) %BlueValue" blockExternalInputs=false
